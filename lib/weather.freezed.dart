...
abstract class $WeatherCopyWith<$Res> {
  ...
  @useResult
  $Res call({int? id, String? name, WeatherMain? main});
...
class _$_Weather with DiagnosticableTreeMixin implements _Weather {
  _$_Weather({this.id, this.name, this.main});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Weather(id: $id, name: $name, main: $main)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, name, main);
